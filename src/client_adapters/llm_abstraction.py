...
class AbstractLLMProvider(ABC):
    ...
    - invoke(): obelix_types + tools in, AssistantMessage out
    ...
    async def invoke(self, messages: List[StandardMessage], tools: List[ToolBase]) -> AssistantMessage:
        """
        Call the LLM with standardized obelix_types and tools.

        Args:
            messages: List of obelix_types in StandardMessage format
