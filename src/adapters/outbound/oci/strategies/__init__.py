...
from src.adapters.outbound.oci.strategies.generic_strategy import GenericRequestStrategy
from src.adapters.outbound.oci.strategies.cohere_strategy import CohereRequestStrategy
