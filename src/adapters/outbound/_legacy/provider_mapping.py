import json
from src.infrastructure.providers import Providers, ProviderRegistry
...
from src.adapters.outbound._legacy.tool_extr_fall_back import (
...
# NOTE: Anthropic mapping removed - provider is now self-contained
# (see src/client_adapters/anthropic_provider.py)
...
# NOTE: OpenAI mapping removed - provider is now self-contained
