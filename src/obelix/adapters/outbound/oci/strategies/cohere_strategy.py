...
from obelix.adapters.outbound.oci.strategies.generic_strategy import ToolCallExtractionError
...
from obelix.domain.model.tool_message import ToolMessage, ToolCall
