"""Tests for obelix.adapters.outbound.litellm.provider.LiteLLMProvider.
...
def mock_litellm():
    ...
    with (
        patch(
            "obelix.adapters.outbound.litellm.provider._get_litellm",
            return_value=mock_module,
        ),
        patch(
            "obelix.adapters.outbound.litellm.provider._get_litellm_exceptions",
...
class TestExtractToolCalls:
    ...
    def test_malformed_json_raises_extraction_error(self, provider):
        from obelix.adapters.outbound.litellm.provider import ToolCallExtractionError
...
class TestModuleReExport:
    """Tests for obelix.adapters.outbound.litellm.__init__."""
    ...
    def test_all_exports(self):
        import obelix.adapters.outbound.litellm as mod
