"""Tests for obelix.adapters.outbound.oci.connection.
...
class TestOCIAsyncHttpClientInit:
    ...
    @patch("obelix.adapters.outbound.oci.connection.Signer", create=True)
...
class TestOCIAsyncHttpClientRequest:
    ...
    def mock_client(self):
        ...
        with patch.dict(
            ...
            with patch(
                "obelix.adapters.outbound.oci.connection.OCIAsyncHttpClient.__init__",
                return_value=None,
            ):
